...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(Context mContext, ViewGroup parent, LayoutInflater inflater,
        ...
        return create(mContext, parent, inflater, weekdayNameFormat, listener, today, dividerColor,
    ...
    public static MonthView create(Context mContext, ViewGroup parent, LayoutInflater inflater,
        ...
        //TODO:dongyiming.(set year/month)
        view.title.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 92));
        view.title.setBackgroundResource(R.color.color_month_bg);
        view.title.setTextSize((float) 14.3);
        //view.title.setTextSize(mContext.getResources().getDimension(R.dimen.dimen_month_text_size));
        view.title.setTextColor(mContext.getResources().getColor(R.color.color_month_text));
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    if (cell.getDate() != null && cell.isCurrentMonth() && !cellView.getDayOfMonthTextView().getText().equals(cellDate)) {
