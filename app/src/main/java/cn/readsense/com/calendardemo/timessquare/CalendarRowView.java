...
public class CalendarRowView extends ViewGroup implements View.OnClickListener {
    ...
    public CalendarRowView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.calendar_gridview);
        monthHeight = typedArray.getDimension(R.styleable.calendar_gridview_attr_week_height, resources.getDimension(R.dimen.dimen_month_height));
        dayHeight = typedArray.getDimension(R.styleable.calendar_gridview_attr_day_item_height, resources.getDimension(R.dimen.dimen_day_height));
        typedArray.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int heightWithPadding = (int) dayHeight + getPaddingTop() + getPaddingBottom();
