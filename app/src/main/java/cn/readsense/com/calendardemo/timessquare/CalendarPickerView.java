...
public class CalendarPickerView extends ListView {
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        dividerColor = a.getColor(R.styleable.CalendarPickerView_tsquare_dividerColor,
                res.getColor(R.color.color_divider));
        ...
        displayDayNamesHeaderRow =
                a.getBoolean(R.styleable.CalendarPickerView_tsquare_displayDayNamesHeaderRow, false);
    ...
    public FluentInitializer init(Date minDate, Date maxDate, TimeZone timeZone, Locale locale) {
        ...
        while ((monthCounter.get(MONTH) <= maxMonth // Up to, including the month.
            ...
            //MonthDescriptor{label='2008年9月', month=8, year=2008}
    ...
    //MonthDescriptor{label='2008年9月', month=8, year=2008}
    //java.util.GregorianCalendar[time=1222185600000,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=libcore.util.ZoneInfo[id="Asia/Shanghai",mRawOffset=28800000,mEarliestRawOffset=28800000,mUseDst=false,mDstSavings=0,transitions=16],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2008,MONTH=8,WEEK_OF_YEAR=39,WEEK_OF_MONTH=4,DAY_OF_MONTH=24,DAY_OF_YEAR=268,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=4,AM_PM=0,HOUR=0,HOUR_OF_DAY=0,MINUTE=0,SECOND=0,MILLISECOND=0,ZONE_OFFSET=28800000,DST_OFFSET=0]
